...
import { useSuperAdminChangePassword } from '@/app/hooks/useSuperAdminChangePassword';
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute right-3 top-1/2 -translate-y-1/2 text-[#2d2d2d] hover:text-[#8b6f47] focus:outline-none"
                tabIndex={-1}
              >
                {showCurrentPassword ? (
          ...
          <div className="flex justify-end gap-4">
            <button
              type="submit"
              disabled={changePasswordMutation.isPending}
              className="px-6 py-3 bg-[#8b6f47] text-white font-bold text-lg rounded hover:opacity-90 transition-opacity disabled:opacity-50 disabled:cursor-not-allowed"
            >
